...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphoneredmi.id, 
        'brand': DEV_SCALE_bran[smartphoneredmi.brand], 
        'ram': DEV_SCALE_ram[smartphoneredmi.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphoneredmi.prosesor], 
        'storage': DEV_SCALE_storage[smartphoneredmi.storage], 
        'baterai': DEV_SCALE_baterai[smartphoneredmi.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphoneredmi.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphoneredmi.harga]} for smartphoneredmi in session.scalars(query)]
